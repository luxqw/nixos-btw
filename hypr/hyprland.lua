...
hl.monitor({
    output   = "eDP-1", -- Pro-tip: Run `hyprctl monitors` and replace this with your actual port name (e.g., HDMI-A-1)
    mode     = "2560x1600@60",
    position = "3440x0",
    scale    = "1.33",
})
...
-- Put workspaces 1-8 on the big monitor
for w = 1, 8 do
    hl.workspace_rule({ workspace = tostring(w), monitor = "DP-2" })
end

-- Put workspace 9 on the laptop monitor
...
hl.on("hyprland.start", function()
    hl.exec_cmd("swaybg -i /home/lux/Documents/walls/wall1.jpg")
end)
